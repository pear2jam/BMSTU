...
- Разработка грамматики языка L4, включающей описание типов
  данных, выражений,
...
Несмотря на интерестный опыт написания такого парсера,
этот метод выглядит не оптимальным решением задачи разбора дерева,
так как даже для такой небольшой грамматики, было написано очень много
кода, который на больших грамматиках будет расширяться еще сильнее.
Также такой функционал является плохо расширяемым, в случаях, если
мы захотим ввести новые правила, новые возможности языка
